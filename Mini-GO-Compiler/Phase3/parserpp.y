...
%right T_S_BINARY_OPERATOR;
%right T_UNARY_OPERATOR;
%right LOL;
...
%type<stt> While WhileHead Switch SwitchBody SwitchHead CaseHead DefaultHead PrintBody OpenScope OpenParan CloseScope Expression3 PrintInsider Operation
...
CPro:						Main {check($1);typeCheck($1);DisplaySymbolTable($1);$$=$1;$$ -> parent = NULL;}
...
IOStatement:				T_PRINT OpenParan PrintBody Comma PrintInsider CloseParan SemiColon {$$ = createEntry(yylineno, "Print", none, none, none, 7, makeOpNode("PrintKey", "printf", yylineno), $2, $3, $4, $5, $6, $7);error_taker = $$;}
                        |   T_PRINT OpenParan T_STRING CloseParan SemiColon {$$ = createEntry(yylineno, "Print", none, none, $3, 4, makeOpNode("PrintKey", "printf", yylineno), $2, $4, $5);error_taker = $$;}
