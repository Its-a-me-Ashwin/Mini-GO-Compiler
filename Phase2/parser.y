...
%type<stt> Go Import Main BasicScope Scope VariableDefine Expression IOStatement Scope2 Scope3 LoopScope2 Ids AssignOp AssignInOp Assign2 Expression4
...
Go:						T_PACKAGE T_MAIN Import {error_taker = $$;}
